...
impl SeedDialog {
    pub fn new(seed: String) -> Self {
        let mut window = SeedDialog {
            base: ModalWindow::new("Set Seed", Layout::new("d:c,w:20%,h:20%"), window::Flags::None),
            seed_input: Handle::None,
            confirm_button: Handle::None
        };
        
        let seed_input = TextField::new(&seed, Layout::new("x:0,y:0%,w:100%,h:50%"), textfield::Flags::None);
